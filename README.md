...
把想法做成能用的产品：AI 应用 · 自动化 · 从原型到上线。

*I build things that ship: AI apps, automation pipelines, and open-source tools.*
...
| [神通百问](https://shentong.wangwangpindou.top) | 趣味决策小工具：小六壬起卦问答 |
| [个人主页](https://bochengai.top) | 关于我 + 全部作品入口（coming soon） |

**技术栈**

Python · Node.js · React/TS · FastAPI · Playwright / 浏览器自动化 · ffmpeg
